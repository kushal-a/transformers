...
\\
2-heads-2-layers-lr-1e-4: \textbf{0.047525} \\
4-heads-6-layers-lr-1e-4: \textbf{0.025231} \\
4-heads-6-layers-lr-1e-3: \textbf{0.000377} 
\begin{figure}[H]
    \centering
    % TODO: put your plot here.
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case1_loss_out.png}
        \caption{2-heads-2-layers-lre-4}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case2_loss_out.png}
        \caption{4-heads-6-layers-lre-4}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case3_loss_out.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case1_train_4.png}
        \caption{Sample1: 2-heads-2-layers-lre-4}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case2_train_4.png}
        \caption{Sample2:4-heads-6-layers-lre-4}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/case3_train_4.png}
...
\\ 
% YOU ANSWER HERE
From case 1 to case 2, we can see that increasing heads and layers improved performance. So I would increase the number of heads and layers. Further from case 2 to case 3, although the loss goes down, the predictions themselves are not that good. So I would maintain a learning rate of 1e-3. More generally, the model is very shallow to incorporate the intricacies of sentences. Increasing the model size would improve performance.
\end{solution}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{transformer_captioning/plots/swiglu_loss_out.png}
...
SwiGLU produced longer captions than the previous case. It was better at sentences without repeating words. The error produced at training was somewhere between case 2 and 3 from the previous case. The samples showed similar effect. They were better than case 2, being better structured. Case 3 had shorter captions but was more accurate. SwiGLU performed somewhere in between. This could be because the SwiGLU adds more layers to the model, giving it more space to learn on the data. 
\end{solution}
...
\begin{solution}
\\ 
Test Accuracy: \textbf{65.7900\%}

Train Accuracy: \textbf{99.9980\%}

Training Loss: \textbf{0.040039}
% YOU ANSWER HERE
\end{solution}
